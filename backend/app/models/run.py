...
class TestResult(Base):
    ...
    total_latency_ms: Mapped[float | None] = mapped_column(Float, nullable=True, comment="End-to-end pipeline latency")
    asr_latency_ms: Mapped[float | None] = mapped_column(Float, nullable=True, comment="ASR transcription latency")
    input_tokens: Mapped[int | None] = mapped_column(Integer, nullable=True, comment="LLM input tokens")
    output_tokens: Mapped[int | None] = mapped_column(Integer, nullable=True, comment="LLM output tokens")
